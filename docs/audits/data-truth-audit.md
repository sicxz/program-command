...
| Recommendations and optimizer dashboards (`pages/recommendations-dashboard.html`, `pages/course-optimizer-dashboard.html`) | `legacy-fallback` | User-visible recommendations still read directly from local workload and enrollment files | `pages/recommendations-dashboard.html`, `pages/course-optimizer-dashboard.html` |
