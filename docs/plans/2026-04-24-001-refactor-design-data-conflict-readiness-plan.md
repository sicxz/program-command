...
type: refactor
status: superseded-mechanics, live-roadmap
date: 2026-04-24
origin: docs/brainstorms/2026-04-16-production-readiness-multi-department-program-requirements.md
deepened: 2026-04-24
salvaged: 2026-06-11 from the scheduler-v2-codex-develop-fix sibling clone (only surviving copy) as Unit 10 rescue group G0
---

> **Salvage note (2026-06-11):** this plan's branch mechanics (develop-based
> targets, `codex/production-readiness-audit` carry-forward) are superseded by
> the 2026-05-15 Forward Operating Model plan — `develop` is being rescued and
> retired, and `main` is the only trunk. Its **product roadmap** (Design data
> truth, canonical persisted bundle, explainable conflict engine, guided
> conflict-resolution workflow) remains live and should inform post-Unit-12
> planning. See docs/phase2-unit10-inventory.html.
